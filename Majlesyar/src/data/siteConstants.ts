...
export const eventTypes: EventType[] = [
  ...
  },
  {
    ...
    seoTitle: "سفارش حلوا و خرما برای مراسم",
    seoDescription:
      "خرید و سفارش حلوا و خرما برای مراسم ترحیم، ختم و یادبود. حلوا مجلسی، خرمای بسته‌بندی‌شده و پک‌های پذیرایی با آماده‌سازی سریع در تهران و البرز.",
    seoKeywords: [
      "حلوا و خرما",
      "سفارش حلوا و خرما",
      "حلوا ترحیم",
