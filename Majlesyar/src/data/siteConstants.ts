...
export const eventTypes: EventType[] = [
  {
    ...
    description: "مشاهده لیست انواع فود، دسر و محصولات پذیرایی برای سفارش‌های شرکتی و رسمی",
  ...
  },
  {
    ...
    slug: "party",
    routePath: "/flower",
    description: "مشاهده بخش گل و گل‌آرایی برای تبریک، شادی، ترحیم و مناسبت‌های رسمی",
  ...
  },
  {
    ...
    slug: "pack",
    routePath: "/pack",
    description: "سفارش پک میوه و پذیرایی با ارسال سریع تهران و البرز",
  ...
  },
  {
    ...
    routePath: "/flower/congratulatory-wreaths",
...
export const defaultSettings: Settings = {
  ...
  siteBranding: {
    ...
    siteTagline: "محصولات پذیرایی، گل، فینگر فود، حلوا و خرما",
    logoAlt: "لوگوی مجلس یار",
    metaAuthor: "مجلس یار",
    defaultMetaTitle: "مجلس یار | سفارش آنلاین محصولات پذیرایی، گل، فینگر فود، حلوا و خرما",
    defaultMetaDescription:
      "مجلس یار مرجع سفارش آنلاین محصولات پذیرایی، پک میوه، پک ترحیم، فینگر فود، گل، حلوا و خرما در تهران و البرز با کیفیت تازه، ارسال هماهنگ و امکان پرداخت پس از تایید کیفیت است.",
    defaultMetaKeywords: [
      "پک پذیرایی",
      "پک نذری",
      "کترینگ مراسم",
  ...
  pageSeo: {
    home: {
      title: "مجلس یار | سفارش آنلاین محصولات پذیرایی، گل، فینگر فود، حلوا و خرما",
      description:
        "مجلس یار مرجع سفارش آنلاین محصولات پذیرایی، پک میوه، پک ترحیم، فینگر فود، گل، حلوا و خرما در تهران و البرز با کیفیت تازه، ارسال هماهنگ و امکان پرداخت پس از تایید کیفیت است.",
      keywords: [
        "حلوا",
