...
from .views import AdminSiteSettingRetrieveUpdateAPIView, HealthAPIView, PingAPIView, SiteSettingRetrieveAPIView
...
urlpatterns = [
    ...
    path("health/", HealthAPIView.as_view(), name="site-health"),
]
